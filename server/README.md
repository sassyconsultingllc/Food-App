<!--
   ...
   CodeMark: SCLLC1-foodie_finder_v8-ZTAVIDH3PWMZ
-->
...
**Removed** — This project no longer implements server-side authentication or license management. All related server routes and client-side login flows have been removed. If you need authentication in the future, the previous implementation can be restored from Git history or re-implemented as a separate feature.
